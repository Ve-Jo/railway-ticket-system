...
INSERT INTO roles (code, name, description) VALUES
    ('passenger', 'Пассажир', 'Пользователь, который ищет рейсы, бронирует и оплачивает билеты.'),
    ('cashier', 'Кассир', 'Сотрудник, который может оформлять продажи и возвраты через служебный интерфейс.'),
    ('admin', 'Администратор', 'Пользователь с доступом к управлению справочниками и журналам операций.');
